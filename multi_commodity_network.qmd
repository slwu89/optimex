---
title: "The network multi-commodity flow problem"
author: "Sean L. Wu"
date: "12/19/2023"
format: gfm
jupyter: julia-1.9
...
This page reformulates the exact same problem described in the JuMP documentation page ["The network multi-commodity flow problem"](https://jump.dev/JuMP.jl/stable/tutorials/linear/multi_commodity_network/) using tools from Catlab.jl (attributed C-Sets). The JuMP tutorial is intended to show how to "a style of modeling that uses relational algebra". In practice, 
